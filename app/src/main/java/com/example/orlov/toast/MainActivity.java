package com.example.orlov.toast;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void  b1(View v){
        Toast.makeText(this,"I know",Toast.LENGTH_LONG).show();
    }
    ...
    public void b3(View v){
        Toast toast=Toast.makeText(this,"I am little yellow man",Toast.LENGTH_LONG);
